    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=32, null=True, verbose_name='分类编码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(blank=True, max_length=128, null=True, verbose_name='简单描述')),
                ...
                ('image', models.ImageField(upload_to='product', verbose_name='主要图片')),
                ...
                ('stock_count', models.IntegerField(default=0, verbose_name='库存')),
                ...
                ('is_valid', models.BooleanField(default=False, verbose_name='商品是否有效')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='修改时间')),

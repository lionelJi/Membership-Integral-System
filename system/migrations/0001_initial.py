# -*- coding: utf-8 -*-
# Generated by Django 1.11.22 on 2019-07-19 02:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reorder', models.SmallIntegerField(default=0, help_text='数字越大，越靠前展示', verbose_name='排序')),
                ('start_time', models.DateTimeField(blank=True, null=True, verbose_name='开始生效时间')),
                ('end_time', models.DateTimeField(blank=True, null=True, verbose_name='结束生效时间')),
                ('view_count', models.IntegerField(default=0, verbose_name='浏览次数')),
                ('is_top', models.BooleanField(default=False, verbose_name='是否置顶')),
                ('is_valid', models.BooleanField(default=True, verbose_name='是否仍有效_未删除')),

...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('accounts', '0002_auto_20190719_0704'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='comments',
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_query_name='comments', to='mine.Order', verbose_name='订单'),
        ),
        migrations.AddField(
            model_name='comments',
            name='product',
